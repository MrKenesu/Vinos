...
public class TestVinos {
	...
	public static void main(String[] args) {
		...
		testObtenerVinoMejorPutuado();
		testCalcularUvasRegion();
	...
	private static void testCalcularNumeroVinosPais() {
		...
		try {
			...
			System.out.println("  VINOS: " + vinos.calcularNumeroVinoPais("Spain"));
		} catch(Exception e) {
			System.out.println("Excepción capturada:\n   " + e);	
		}
	}
	
	private static void testObtenerVinoMejorPutuado() {
		System.out.println("\nTEST de obtenerVinoMejorPutuado");
		try {
			System.out.println("  VINO: " + vinos.obtenerVinoMejorPutuado());
		} catch(Exception e) {
			System.out.println("Excepción capturada:\n   " + e);	
		}
	}
	
	private static void testCalcularUvasRegion() {
		System.out.println("\nTEST de calcularUvasRegion");
		try {
			System.out.println("  UVAS DE California: " + vinos.calcularUvasRegion("California"));
		} catch(Exception e) {
			System.out.println("Excepción capturada:\n   " + e);	
		}
	}
	...
	private static void testCalcularUvasPorPais() {
		...
		try {
			System.out.println("  UVAS POR PAIS: " + vinos.calcularCuantasUvasPorPais());
		} catch(Exception e) {
			System.out.println("Excepción capturada:\n   " + e);	
		}
	}
